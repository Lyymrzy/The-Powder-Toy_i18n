	...
	ui::Window(ui::Point((XRES-244)/2, (YRES-90)/2), ui::Point(244, 90))
{
	...
	textWidth = Graphics::TextSize("点击下面的框以复制存档 ID").X - 1;
	ui::Label * copyTextLabel = new ui::Label(ui::Point((Size.X-textWidth-20)/2, 35), ui::Point(textWidth+20, 16), "点击下面的框以复制存档 ID");
