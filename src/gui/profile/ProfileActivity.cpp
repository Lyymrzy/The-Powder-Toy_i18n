...
void ProfileActivity::setUserInfo(UserInfo newInfo)
{
	...
	if (editable)
	{
		ui::Button * editAvatar = new ui::Button(ui::Point(Size.X - (40 + 16 + 75), currentY), ui::Point(75, 15), "编辑头像");
	...
	// age
	ui::Label * ageTitle = new ui::Label(ui::Point(4, currentY), ui::Point(40, 15), "年龄：");
	...
	ui::Label *age = new ui::Label(ui::Point(5+ageTitle->Size.X, currentY), ui::Point(Size.X-ageTitle->Size.X-56, 15), info.age ? String::Build(info.age) : "\bg未填写");
	age->Appearance.HorizontalAlign = ui::Appearance::AlignLeft;
	scrollPanel->AddChild(age);
	currentY += 2+age->Size.Y;

	// location
	ui::Label * locationTitle = new ui::Label(ui::Point(4, currentY), ui::Point(45, 15), "位置：");
	...
	// saves
	ui::Label * savesTitle = new ui::Label(ui::Point(4, currentY), ui::Point(40, 15), "存档：");
	...
	currentY += savesTitle->Size.Y;
		...
		// saves count
		ui::Label * saveCountTitle = new ui::Label(ui::Point(12, currentY), ui::Point(40, 15), "数量：");
		...
		// average score
		ui::Label * averageScoreTitle = new ui::Label(ui::Point(12, currentY), ui::Point(72, 15), "平均分：");
		...
		// highest score
		ui::Label * highestScoreTitle = new ui::Label(ui::Point(12, currentY), ui::Point(71, 15), "最高分：");
	...
	// biograhy
	ui::Label * bioTitle = new ui::Label(ui::Point(4, currentY), ui::Point(50, 15), "简介：");
...
void ProfileActivity::OnTick()
{
	...
	if (getUserInfoRequest && getUserInfoRequest->CheckDone())
	{
		...
		{
			doError = true;
			doErrorMessage = "无法载入用户资料：" + ByteString(ex.what()).FromUtf8();
		}
